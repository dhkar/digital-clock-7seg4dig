...
void loop()
{
  ...
  if ((count > triggerAlarmVal) && (count < 20+triggerAlarmVal )) {
...
void stateHandler() {
  ...
  if (state == 4) {
    printToSevSeg(mntsAlarm / 10, mntsAlarm % 10, secsAlarm / 10, secsAlarm % 10, true, true, false, false);
  }
  if (state == 31) {
